                            ...
                            if row[0] not in (None,"") and row[1] not in (None,""):
                                ...
                                if row[0] != running_tmpl:
                                    ...
                                    if self.product_update_by == 'name':   
                                        ...
                                        running_tmpl_domain = [
                                            ('product_variant_ids.barcode','=',row[17] ),
                                            ]                                          
                                            
                                                                             
                                    elif self.product_update_by == 'int_ref':
                                        running_tmpl_domain = [
                                            ('product_variant_ids.default_code','=',row[16] ),
                                            ]  
                                    ...
                                    if row[6].strip() in (None,""):
                                        ...
                                        search_uom = self.env['uom.uom'].search([('name','=',row[6].strip())], limit = 1)
                                        if search_uom:
                                            tmpl_vals.update({'uom_id' : search_uom.id }) 
                                        else:
                                    ...
                                    if row[7].strip() in (None,""):
                                        ...
                                        search_uom_po = self.env['uom.uom'].search([('name','=',row[7].strip())], limit = 1)
                                        if search_uom_po:
                                            tmpl_vals.update({'uom_po_id' : search_uom_po.id }) 
                                        else:
                                    ...
                                    tmpl_vals.update({'description_sale' : row[10] })   
                                    ...
                                    if row[12] not in (None,""):
                                        tmpl_vals.update({'list_price' : row[12]})
                                    
                                    if row[13] not in (None,""):
                                        tmpl_vals.update({'standard_price' : row[13]})                                            
                                    ...
                                    if row[14].strip() in (None,"") or row[15].strip() in (None,""):
                                        ...
                                        if row[16] not in (None,""):                                         
                                            tmpl_vals.update({'default_code' : row[16]})   
                                        
                                        if row[17] not in (None,""):
                                            tmpl_vals.update({'barcode' : row[17]})                                                                                                                                                                                                                                  
                                                                                       
                                        if row[18] not in (None,""):
                                            tmpl_vals.update({'weight' : row[18]})       
                                            
                                        if row[19] not in (None,""):
                                            tmpl_vals.update({'volume' : row[19]})  
                                    ...
                                    if self.method == 'create':
                                        ...
                                        search_product = product_tmpl_obj.search(running_tmpl_domain, limit = 1)
...
#                                         created_product_tmpl.attribute_line_ids = False
                                    ...
                                    if row[14].strip() not in (None,"") and row[15].strip() not in (None,""):
                                        ...
                                        if self.method == 'create':
                                            ...
                                            if created_product_tmpl.product_variant_ids:
                                                ...
                                                if row[16] not in (None,""):                                         
                                                    var_vals.update({'default_code' : row[16]})   
                                                
                                                if row[17] not in (None,""):
                                                    var_vals.update({'barcode' : row[17]})                                                                                                                                                                                                                                                                           
                                                                                               
                                                if row[18] not in (None,""):
                                                    var_vals.update({'weight' : row[18]})       
                                                    
                                                if row[19] not in (None,""):
                                                    var_vals.update({'volume' : row[19]})  
                                ...
                                skipped_line_no[str(counter)]=" - Name or Unique identifier is empty. "  
                                counter = counter + 1                                   
