...
class AttachmentBooleanFields(models.Model):
    _inherit = 'res.partner'

    is_a_dist = fields.Boolean("Is A Boolean")
    is_a_dealer = fields.Boolean("Is A Dealer")
    is_a_retailer = fields.Boolean("Is A Retailer")
    cnic_no = fields.Char("CNIC")